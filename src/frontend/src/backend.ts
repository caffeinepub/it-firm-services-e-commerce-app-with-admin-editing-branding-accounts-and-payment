...
import type { LanguageConfig as _LanguageConfig, OrderItem as _OrderItem, Product as _Product, ServiceItem as _ServiceItem, SiteBranding as _SiteBranding, SocialLinks as _SocialLinks, StripeSessionStatus as _StripeSessionStatus, UserProfile as _UserProfile, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async createOrder(arg0: Array<Product>, arg1: bigint): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.createOrder(to_candid_vec_n10(this._uploadFile, this._downloadFile, arg0), arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async createProduct(arg0: Product): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.createProduct(to_candid_Product_n11(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async createService(arg0: ServiceItem): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.createService(to_candid_ServiceItem_n13(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getCallerOrders(): Promise<Array<OrderItem>> {
        if (this.processError) {
            try {
    ...
    async getSiteBranding(): Promise<SiteBranding> {
        if (this.processError) {
            try {
                ...
                return from_candid_SiteBranding_n28(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
    ...
    async initialize(arg0: StripeConfiguration): Promise<void> {
        if (this.processError) {
            try {
    ...
    async updateBranding(arg0: SiteBranding): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateBranding(to_candid_SiteBranding_n33(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_ServiceItem_n26(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _ServiceItem): ServiceItem {
    return from_candid_record_n27(_uploadFile, _downloadFile, value);
}
function from_candid_SiteBranding_n28(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _SiteBranding): SiteBranding {
...
function from_candid_record_n17(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    timestamp: bigint;
    customerId: Principal;
    orderedProducts: Array<_Product>;
}): {
    id: bigint;
    status: string;
    totalAmount: bigint;
    ...
    return {
        ...
        orderedProducts: from_candid_vec_n18(_uploadFile, _downloadFile, value.orderedProducts)
    };
}
...
function from_candid_record_n27(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        title: value.title,
        description: value.description,
        pricing: record_opt_to_undefined(from_candid_opt_n7(_uploadFile, _downloadFile, value.pricing)),
        imageUrl: record_opt_to_undefined(from_candid_opt_n21(_uploadFile, _downloadFile, value.imageUrl)),
        category: value.category
    };
}
function from_candid_record_n29(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        logo: record_opt_to_undefined(from_candid_opt_n21(_uploadFile, _downloadFile, value.logo)),
        languageConfig: value.languageConfig,
        storeBanners: value.storeBanners,
        homepageSliderImages: value.homepageSliderImages
    };
}
...
function from_candid_vec_n25(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_ServiceItem>): Array<ServiceItem> {
    return value.map((x)=>from_candid_ServiceItem_n26(_uploadFile, _downloadFile, x));
}
...
function to_candid_ServiceItem_n13(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: ServiceItem): _ServiceItem {
    return to_candid_record_n14(_uploadFile, _downloadFile, value);
}
function to_candid_SiteBranding_n33(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: SiteBranding): _SiteBranding {
...
function to_candid_record_n14(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        title: value.title,
        description: value.description,
        pricing: value.pricing ? candid_some(value.pricing) : candid_none(),
        imageUrl: value.imageUrl ? candid_some(value.imageUrl) : candid_none(),
        category: value.category
    };
}
...
function to_candid_vec_n10(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<Product>): Array<_Product> {
    return value.map((x)=>to_candid_Product_n11(_uploadFile, _downloadFile, x));
}
